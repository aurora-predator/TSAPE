...
from data.dataloader.abstract_dataloader import AbstractDataLoader
from data.dataloader.general_dataloader import TrainDataLoader
from data.interaction import Interaction
from utils import InputType, KGDataLoaderState
import numpy as np
...
class KnowledgeBasedDataLoader:
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                - :obj:`~utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~utils.enum_type.KGDataLoaderState.RSKG`
