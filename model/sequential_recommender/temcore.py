...
class TransNet(nn.Module):
    ...
    def forward(self, item_seq, item_emb, time_seq):
        mask = item_seq.gt(0)
...
class TEMCORE(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        super(TEMCORE, self).__init__(config, dataset)
    ...
    def forward(self, item_seq, time_seq):
        ...
        alpha = self.net(item_seq, x, time_seq)
