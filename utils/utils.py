...
def get_trainer(model_type, model_name):
    ...
    try:
        return getattr(
            importlib.import_module("trainer"), model_name + "Trainer"
        )
    except AttributeError:
        if model_type == ModelType.KNOWLEDGE:
            return getattr(importlib.import_module("trainer"), "KGTrainer")
        elif model_type == ModelType.TRADITIONAL:
            return getattr(
                importlib.import_module("trainer"), "TraditionalTrainer"
            )
        else:
